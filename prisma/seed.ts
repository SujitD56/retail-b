...
async function main() {
  ...
  // ---------- Categories ----------
  const categories = [
    { slug: "cotton-ilkal", name: "COTTON_ILKAL" as const, description: "100% fine cotton yarn, classic comfort for everyday elegance.", imageUrl: "/images/customer/category-cotton-ilkal.png" },
    { slug: "silk-cotton", name: "SILK_COTTON" as const, description: "An exquisite blend of pure mulberry silk and premium long-staple cotton.", imageUrl: "/images/customer/category-silk-cotton.png" },
    { slug: "traditional-ilkal", name: "TRADITIONAL_ILKAL" as const, description: "Time-tested weave pattern with iconic red silk pallu and Chikki border.", imageUrl: "/images/customer/category-traditional-ilkal.png" },
    { slug: "contemporary-ilkal", name: "CONTEMPORARY_ILKAL" as const, description: "Modern pastel palettes and modified stripes suited for minimalist styling.", imageUrl: "/images/customer/category-contemporary-ilkal.png" },
    { slug: "wedding-sarees", name: "WEDDING_SAREE" as const, description: "Opulent pure silk creations embellished with intricate Kasuti embroidery.", imageUrl: "/images/customer/category-wedding-sarees.png" },
    { slug: "festive-sarees", name: "FESTIVE_SAREE" as const, description: "Vibrant hues and metallic border variants to elevate sacred celebrations.", imageUrl: "/images/customer/category-festive-sarees.png" },
  ];
  ...
  const collectionSeeds = [
    { slug: "handpicked-ilkal", title: "Handpicked Ilkal", description: "Direct selection of finest weaver masterpieces.", coverUrl: "/images/customer/collection-handpicked-ilkal.png", productMockIds: [...productIdByMockId.keys()] },
    { slug: "festive-edit", title: "Festive Edit", description: "Deep celebratory colors with rich lustrous borders.", coverUrl: "/images/customer/collection-festive-edit.png", productMockIds: ["prod_emerald_kasuti", "prod_trad_red_border"] },
    { slug: "heritage-collection", title: "Heritage Collection", eyebrow: "Heritage Masterpieces", description: "Timeless Ilkal sarees featuring traditional weaving patterns passed down through generations. Each piece tells a story of Karnataka's rich textile heritage.", coverUrl: "/images/customer/collection-heritage.png", heroImageUrl: "/images/customer/collection-hero-heritage.png", productMockIds: ["prod_trad_red_border", "prod_navy_chikki_paras", "prod_emerald_kasuti"] },
    { slug: "contemporary-ilkal", title: "Contemporary Ilkal", description: "Lighter weaves and offbeat pastel tones.", coverUrl: "/images/customer/collection-contemporary.png", productMockIds: ["prod_pastel_lavender", "prod_emerald_kasuti"] },
  ];
  ...
  const event =
    ...
    (await prisma.marketplaceEvent.create({
      data: {
        ...
        bannerUrl: "/images/customer/events-landing-hero.png",
        status: "LIVE",
  ...
  const entrySeeds = [
    { retailer: "ret_lakshmi", product: "prod_trad_red_border", title: "Heritage in Crimson", imageUrl: "/images/customer/product-trad-red-border.png", votes: 3420, submittedAt: new Date("2026-08-03") },
    { retailer: "ret_kaveri", product: "prod_navy_chikki_paras", title: "Indigo Reverie", imageUrl: "/images/customer/product-navy-chikki-paras.png", votes: 3105, submittedAt: new Date("2026-08-02") },
    { retailer: "ret_vardhaman", product: "prod_emerald_kasuti", title: "Emerald Devotion", imageUrl: "/images/customer/product-emerald-kasuti.png", votes: 2876, submittedAt: new Date("2026-08-05") },
    { retailer: "ret_karnataka_weaver", product: "prod_pastel_lavender", title: "Modern Minimal", imageUrl: "/images/customer/product-pastel-lavender.png", votes: 2340, submittedAt: new Date("2026-08-06") },
    { retailer: "ret_lakshmi", product: "prod_mustard_gold", title: "Golden Hour", imageUrl: "/images/customer/product-mustard-gold.png", votes: 2108, submittedAt: new Date("2026-08-04") },
    { retailer: "ret_kaveri", product: "prod_crimson_chikki_paras", title: "Bridal Radiance", imageUrl: "/images/customer/product-crimson-chikki-paras.png", votes: 1980, submittedAt: new Date("2026-08-07") },
    { retailer: "ret_sri_krishna", product: "prod_sri_krishna_zari_drape", title: "Zari Legacy", imageUrl: "/images/customer/retailer-5-preview-1.png", votes: 1750, submittedAt: new Date("2026-08-08") },
    { retailer: "ret_hemavati", product: "prod_hemavati_heritage_cotton", title: "12th Century Revival", imageUrl: "/images/customer/retailer-6-preview-1.png", votes: 1522, submittedAt: new Date("2026-08-09") },
  ];
  ...
  const hallOfFameSeeds = [
    { year: 2025, entryTitle: "Threads of Tradition", retailer: "ret_lakshmi", imageUrl: "/images/customer/product-crimson-zari-wedding.png", votes: 4210 },
    { year: 2024, entryTitle: "Woven Sunrise", retailer: "ret_kaveri", imageUrl: "/images/customer/product-indigo-chikki-paras.png", votes: 3890 },
    { year: 2023, entryTitle: "Silk & Story", retailer: "ret_vardhaman", imageUrl: "/images/customer/product-sage-green-minimalist.png", votes: 3540 },
  ];
